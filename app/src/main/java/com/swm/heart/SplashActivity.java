 ...
 */
public class SplashActivity extends SwmBaseActivity implements View.OnClickListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SwmDeviceController.init(this);

        // Start swm service
        Intent swmServiceIntent = new Intent(this, SwmService.class);
        startService(swmServiceIntent);
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        Intent intent = new Intent(SplashActivity.this, GenderAndAgeActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
    ...
    private void showProgressDialog() {
        if (mProgressDialog == null) {
            ...
            mProgressDialog.setMessage(getString(R.string.swm_sign_in_loading));
