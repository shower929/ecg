...
public class BleDeviceListItemViewHolder {
    ...
    public BleDeviceListItemViewHolder(View group) {
        mDeviceName = (TextView) group.findViewById(com.swm.ble.R.id.swm_ble_device_name);
        mDeviceAddress = (TextView) group.findViewById(com.swm.ble.R.id.swm_ble_device_address);
        mItemLayout = group;
    }
