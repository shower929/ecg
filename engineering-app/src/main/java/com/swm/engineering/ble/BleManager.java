 ...
 */
 public class BleManager {
    ...
    public void connectDevice(BluetoothDevice device) {
        SwmDeviceModule.newDevice(mContext, device).connect(new DeviceCallback() {
            @Override
    ...
    public synchronized void startScan(boolean autoRescan, @Nullable final String address, @NonNull final BleManagerCallback callback) {
        if(mScanning)
            return;
    ...
    void removeListener() {
        SwmDeviceModule.getDevice().removeListener();
    }

    void disconnect() {
        SwmDeviceModule.getDevice().disconnect();
    }
}
