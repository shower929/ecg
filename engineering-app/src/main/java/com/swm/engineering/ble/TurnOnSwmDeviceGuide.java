 ...
 */
public class TurnOnSwmDeviceGuide extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turn_on_swm_device_guide);
        ...
        // Set up the user interaction to manually start or stop the system UI.
        ...
        // Upon interacting with UI controls, delay any scheduled stop()
        // operations to prevent the jarring behavior of controls going away
        // while interacting with the UI.
        findViewById(R.id.dummy_button).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.swm_ble_cta).setOnClickListener(this);
    }
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        // Trigger the initial stop() shortly after the activity has been
    ...
    /**
     * Schedules a call to stop() in [delay] milliseconds, canceling any
    ...
    public void onClick(View v) {
        ...
        String address = pref.getString(SwmPref.SWM_DEVICE_ADDRESS, null);
        if (TextUtils.isEmpty(address)) {
            Intent intent = new Intent(this, DeviceDiscoverAndConnActivity.class);
            startActivity(intent);
            finish();
        } else {
            BleManager manager = new BleManager(this);
            manager.startScan(true, address, new BleManagerCallback() {
                @Override
    ...
    private void connect(BluetoothDevice device) {
        SwmDeviceModule.newDevice(this, device).connect(new DeviceCallback() {
            @Override
