...
class InformationBleProfile {
    ...
    InformationBleProfile(BluetoothGattService service, BleDevice device) {
        this.device = device;
    ...
    void readFirmwareRevision(BluetoothGatt gatt) {
        device.sendCommand(BleCommandHelper.getReadCommand(mFirmwareRevisionChar));
    }
    ...
    void readManufactureName(BluetoothGatt gatt) {
        device.sendCommand(BleCommandHelper.getReadCommand(mManufactureNameChar));
    }
