...
class OneFiveZeroOne extends HeartMotionDevice{
    ...
    private BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            if (characteristic.getUuid().equals(EcgBleProfile.DATA))
    ...
    OneFiveZeroOne(Context context, BluetoothDevice device) {
        mContext = context;
        mDevice = device;
    ...
    @Override
    public synchronized void setListener(DeviceListener listener) {
        mListener = listener;
        if(mListener == null)
            return;
        notifyUpdate();
